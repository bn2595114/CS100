...
class SingleRed: public Shell
{
    ...
    public:
    SingleRed(Shell* passLeft, Shell* passRight)
    {
        esc = false;
        fail = 0;
        left = passLeft;
    ...
    void execute()
    {
        ...
        //Create if does not exist, and write only.
        fs = open(commandString.c_str(), O_CREAT | O_WRONLY);
        ...
        //Execution logic for output redirection wtih overwriting.
        int status;
